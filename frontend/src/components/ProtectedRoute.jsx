      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-slate-950 text-slate-100">
          <div className="glass-panel p-8 rounded-2xl max-w-md text-center border-rose-500/20">
            ...
            <a 
              href="/" 
              className="inline-block bg-slate-800 hover:bg-slate-700 text-slate-200 px-5 py-2.5 rounded-xl border border-slate-700 transition-all text-sm font-medium"
            >
              Return to Dashboard
            </a>
          </div>
