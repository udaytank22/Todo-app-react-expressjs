...
const Button = ({
 ...
 secondary: 'bg-slate-100 hover:bg-slate-700 text-slate-900 border border-slate-700/50 focus:ring-slate-700/20',
 ...
 ghost: 'hover:bg-slate-100/40 text-slate-600 hover:text-slate-900 focus:ring-slate-800/10',
 glass: 'glass-panel hover:bg-slate-100/30 text-slate-900 border border-black/5 focus:ring-white/10',
 };

 // Adjust for light mode overrides where appropriate
 const lightVariants = {
 secondary: ' light:hover:bg-slate-200 light:border-slate-200',
 ghost: 'light:hover:bg-slate-100/60 light:text-slate-500 light:hover:text-slate-800',
 glass: 'light:glass-panel light:hover:bg-slate-50/50 ',
 };
