...
const ManageGroupsModal = ({ isOpen, onClose, mode = 'list', taskId = null }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg flex flex-col h-[70vh] max-h-[800px] animate-in fade-in zoom-in-95 duration-200 border border-slate-200/60 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-2 text-slate-800">
            ...
            <h2 className="text-sm font-bold tracking-tight">{mode === 'assign' ? 'Assign to Group' : 'Manage Groups'}</h2>
          </div>
          <button 
            onClick={onClose}
