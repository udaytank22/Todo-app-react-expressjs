...
const MainLayout = ({ socket, onSyncSuccess, searchVal, onSearchChange, isMailConnected, isDemoMode }) => {
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-slate-950 text-slate-100 light:bg-slate-50 light:text-slate-900 transition-colors duration-300">
      {/* Sidebar Navigation */}
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-xs font-semibold text-slate-100 font-sans leading-snug">
                    {toast.message}
                  </p>
                </div>
                <button
          ...
          if (toast.isAppNotification) {
            return (
              ...
              >
                ...
                <button
                  onClick={() => removeToast(toast.id)}
                  className="text-slate-500 hover:text-slate-300 self-start p-1 transition-colors"
              ...
              >
                ...
                <div className="flex-1 overflow-hidden space-y-1">
                  ...
                  <p className="text-[10px] text-slate-400 truncate">
                    From: <span className="font-semibold text-slate-300">{toast.senderName}</span>
                  </p>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 overflow-hidden space-y-1">
                ...
                <p className="text-[10px] text-slate-400 truncate">
                  Sender: <span className="font-semibold text-slate-300">{toast.senderName}</span>
                </p>
